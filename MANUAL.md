# Manual Setup Steps for Minions Oss-quality
...
Go to **GitHub → mxn2020/minions-oss-quality → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-oss-quality` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-oss-quality-web`
- **GitHub repo**: `mxn2020/minions-oss-quality`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `oss-quality.minions.wtf`

### Documentation
- **Netlify site name**: `minions-oss-quality-docs`
- **GitHub repo**: `mxn2020/minions-oss-quality`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `oss-quality.minions.help`

### Blog
- **Netlify site name**: `minions-oss-quality-blog`
- **GitHub repo**: `mxn2020/minions-oss-quality`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `oss-quality.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `oss-quality.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `oss-quality.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `oss-quality.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-oss-quality/sdk`](https://www.npmjs.com/package/@minions-oss-quality/sdk)
- CLI: [`@minions-oss-quality/cli`](https://www.npmjs.com/package/@minions-oss-quality/cli)
...
Your package: [`minions-oss-quality`](https://pypi.org/project/minions-oss-quality/)
...
| Item | Value |
|------|-------|
| Project | `minions-oss-quality` |
| SDK (npm) | `@minions-oss-quality/sdk` |
| CLI (npm) | `@minions-oss-quality/cli` |
| Python (PyPI) | `minions-oss-quality` |
| GitHub | `github.com/mxn2020/minions-oss-quality` |
| Docs domain | `oss-quality.minions.help` |
| Blog domain | `oss-quality.minions.blog` |
| App domain | `oss-quality.minions.wtf` |

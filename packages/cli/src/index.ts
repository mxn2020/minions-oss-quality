...
/**
 * @minions-oss-quality/cli — CLI for Minions Oss-quality
 *
...
import { customTypes } from '@minions-oss-quality/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Oss-quality'));
        console.log(chalk.dim('Linting rules, test coverage targets, usability checklists, and release gates'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-oss-quality/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-oss-quality/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-oss-quality')}`);
